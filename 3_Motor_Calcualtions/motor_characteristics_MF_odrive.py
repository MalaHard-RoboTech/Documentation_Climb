...
# -------------------------------
# Plotting Torque vs Speed
# -------------------------------
plt.figure(figsize=(10, 6))
plt.plot(rpm_model, torque_model, label="Torque", color='b', linewidth=2)
plt.scatter(max_speed_csv, max_torque_csv, color='orange', s=100, label='Max Power Point')

plt.xlabel("Speed (RPM)")
plt.ylabel("Torque (Nm)")
plt.title("Torque vs Speed (RPM) - Single Motor @ 36V")
plt.grid(True)
plt.legend()
plt.tight_layout()
# plt.show()
